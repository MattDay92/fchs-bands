                ...
                <div className="container-fluid">
                    ...
                    <div className="collapse navbar-collapse justify-content-around" id="navbarNavDropdown">
                        ...
                        <a className="nav-item dropdown">
                            ...
                            <div className="dropdown-menu nav-dropdown py-0">
                                <a className='dropdown-item' target='_blank' href='https://firebasestorage.googleapis.com/v0/b/fchs-bands.appspot.com/o/files%2FMarchingSeasonInfo?alt=media&token=799b1080-3fd8-4ed5-a65e-879a887c11d8' download>2025 Marching Season Information</a>
                                ...
                                <a className='dropdown-item' target='_blank' href='https://firebasestorage.googleapis.com/v0/b/fchs-bands.appspot.com/o/files%2FMBCGAcknoledgment?alt=media&token=01d494e0-4ca2-4881-8e4b-54d2b8d1b4ab' download>MB/CG Acknowledgement Form</a>
                                ...
                                <a className='dropdown-item' target='_blank' href='https://firebasestorage.googleapis.com/v0/b/fchs-bands.appspot.com/o/files%2FFinancialPolicy?alt=media&token=37e38df3-a3a6-4881-a376-cecbabba535e' download>MB/CG Financial Policy</a>
                                <a className='dropdown-item' target='_blank' href='https://firebasestorage.googleapis.com/v0/b/fchs-bands.appspot.com/o/files%2FVolunteerDiscount?alt=media&token=37e38df3-a3a6-4881-a376-cecbabba535e' download>MB/CG Volunteer Discount Information</a>
