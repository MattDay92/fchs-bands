        ...
        <div className='container'>
            ...
            <div class="dropdown subscribe-btn">
                ...
                <ul class="dropdown-menu">
                    <li><a href='webcal://https://calendar.google.com/calendar/ical/franklinschools.org_b9pjnq791l0mb112j43pbfvjrs%40group.calendar.google.com/public/basic.ics' target='_blank' className='dropdown-item'>Add to Desktop Calendar</a></li>
